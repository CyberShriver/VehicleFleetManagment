<%@ Page Title="" Language="C#" MasterPageFile="~/FleetApp/fleet.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="VehicleFleetManagment.FleetApp.Menu" %>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="Menu.aspx">Menu</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-block table-border-style">
                            <div class="table-responsive">
                                ...
                                <table class=""> 
                                    <asp:GridView ID="gdv" DataKeyNames="Menu_Code" ShowHeaderWhenEmpty="true" EmptyDataText="No Records" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <Columns>                                            
                                             ...
                                             <asp:BoundField DataField="Menu_Code" HeaderText="#" Visible="false" />
                                            ...
                                            <asp:TemplateField HeaderText="Access" >
                                                <ItemTemplate>
                                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("Stat") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Action" >
                                                <ItemTemplate>
                                                    <asp:Button ID="btn_Edit" class="btn btn-sm btn-primary mr-4" runat="server" Text="Edit" CommandName="edit" CommandArgument='<%# Eval("Menu_Code") %>' />
                                                    <asp:Button ID="Btn_Delete" class="btn btn-sm btn-danger " runat="server" Text="Delete" CommandName="delet" CommandArgument='<%# Eval("Menu_Code") %>' OnClientClick="return confirm('Do you want to delete It?')" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
