<%@ Page Title="" Language="C#" MasterPageFile="~/FleetApp/fleet.Master" AutoEventWireup="true" CodeBehind="ViewSchedule.aspx.cs" Inherits="VehicleFleetManagment.FleetApp.ViewSchedule" %>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="ViewSchedule.aspx">List-Schedule</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="font-weight-bold">All Schedule Records</h5>
                        ...
                        <div class="card-block table-border-style">
                            <div class="table-responsive">
                                ...
                                <table class="">
                                    <asp:GridView ID="gdv" DataKeyNames="SCHEDULE_ID" ShowHeaderWhenEmpty="true" EmptyDataText="No Records" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                             ...
                                             <asp:BoundField DataField="SCHEDULE_ID" HeaderText="#" Visible="false" />
                                            ...
                                            <asp:TemplateField HeaderText="State">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label456745" runat="server" Text='<%# Eval("State") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:Button ID="btn_Edit" class="btn btn-sm btn-primary mr-4" runat="server" Text="Edit" CommandName="edit" CommandArgument='<%# Eval("SCHEDULE_ID") %>' />
                                                    <asp:Button ID="Btn_Delete" class="btn btn-sm btn-danger " runat="server" Text="Delete" CommandName="delet" CommandArgument='<%# Eval("SCHEDULE_ID") %>' OnClientClick="return confirm('Do you want to delete It?')" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
